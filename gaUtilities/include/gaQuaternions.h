...
namespace gaEngineSDK {
  class GA_UTILITY_EXPORT Quaternions
  {
    ...
    * @return this quaternion equalize.
    */
    Quaternions&
    ...
    * @brief add two quaternions
    * @param quaternion is another quaternion.
    * @return a quaternions with the addition.
    */
    Quaternions
    ...
    * @param quaternion is another quaternion.
    * @return a quaternions with the subtraction in this quaternion.
    */
    Quaternions&
    operator-=(const Quaternions& quaternion);
    ...
    * @brief subtract two quaternions
    * @param quaternion is another quaternion.
    * @return a quaternions with the subtraction.
    */
    Quaternions
    operator-(const Quaternions& quaternion) const;
    ...
    * @brief Compare two quaternions
    * @param quaternion is the quaternion with which it will be compared
    * @return true if this quaternion is different to the other
    */
    bool
    operator!=(const Quaternions& quaternion) const;
    ...
    */
    ...
    /**
    * @brief get the magnitude of this quaternion
    ...
    */
    ...
    /**
    * @brief get the square magnitude of this quaternion
    * @return the magnitude of this quaternion.
    */
    float
    ...
    /**
    * @brief transform this quaternion to it's normalized form.
